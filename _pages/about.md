...
- Privacy-aware efficient LLM. [\[NeurIPS'25 WorkShop\]](https://openreview.net/pdf?id=Dim7kQ8Kol) [\[NeurIPS'25 WorkShop\]](https://openreview.net/pdf?id=n7peBaPUmk)
  
- Efficient LLM reasoning through KGs. Using high-dimensional representations for path retrieval / KG reasoning to reduce memory and computation while preserving reasoning performance. [\[NeurIPS'25 WorkShop\]](https://openreview.net/pdf?id=LnjgQYt64w)
...
- Fair and privacy-aware graph learning / ML. Fairness-aware graph unlearning / machine unlearning. [\[CIKM'25\]](https://dl.acm.org/doi/pdf/10.1145/3746252.3761299)
